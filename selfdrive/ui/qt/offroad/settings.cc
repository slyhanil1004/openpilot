...
SunnypilotPanel::SunnypilotPanel(QWidget* parent) : QWidget(parent) {
  ...
  toggles.append(new ParamControl("BypassLiveParameters",
                                  "Disable Lateral Learner",
                                  "Bypass LiveParameters to disable learner for lateral control. Restart car after using toggle to take the change in effect.",
